...
public abstract class MicroService implements Runnable { 
    ...
    private MessageBusImpl mbInstance;
    ...
    public MicroService(String name) {
        this.name = name;
        mbInstance = MessageBusImpl.getInstance();
        isTerminated = false;
    ...
    public final void run() {
        try {
    	    ...
    	    initialize();
    	    // loop - takes a message - activate the associated callback - which will take the required Ewoks and than sleep for the duration needed
            while(!isTerminated){
                Message current = mbInstance.awaitMessage(this);
                Callback c = callbacks.get(current.getClass());
                c.call(current);
            }
